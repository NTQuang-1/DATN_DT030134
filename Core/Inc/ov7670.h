...
#define HS_STATUS    ((GPIOB->IDR & 0x00004000)  >> 14)   // pdf CD001711090 - p.171
#define VS_STATUS    ((GPIOB->IDR & 0x00000800)  >> 11)
#define PCLK_STATUS  ((GPIOB->IDR & 0x00000400)  >> 10)
...
void OV7670_write_reg(uint8_t reg_addr, uint8_t data);
